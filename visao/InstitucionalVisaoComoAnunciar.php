            ...
            <div class="column">
                <div class="ui list">
                    ...
                    <div class="item">
                      <i class="checkmark icon"></i>
                      <div class="content">
                        <div class="header">Ao finalizar, compre o anúncio que melhor se adeque as duas necessidades 
                            ou anuncie gratuitamente. Para detalhes das diferenças entre os anúncios, clique <a target="_blank" href="index.php?entidade=Plano&acao=precosAnuncios">AQUI</a></div>                        
                      </div><br>
                    </div>
                  </div>
            </div>            
            ...
            <div class="column">
                <div class="ui list">
                    ...
                    <div class="item">
                      <i class="checkmark icon"></i>
                      <div class="content">
                        <div class="header">Você receberá um email assim que seu anúncio for liberado para ser visualizado. Administre seus anúncios cadastrados na sua página principal (finalizar anúncio, editar, alterar valor).</div>                        
                      </div><br>
                    </div>
                  </div>
            </div>  
