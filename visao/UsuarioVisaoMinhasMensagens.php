    ...
    <div class="ui column">
        <div class="jplist-panel">
            ...
            <div 
                        ...
                        <ul>
                            <li><span data-path=".data" data-order="desc" data-type="datetime" data-path="default">Organizar Por</span></li>
                            <li><span data-path=".resposta" data-order="desc" data-type="text">Respondida(s)</span></li>
                            <li><span data-path=".resposta" data-order="asc" data-type="text">Não Respondida(s)</span></li>
