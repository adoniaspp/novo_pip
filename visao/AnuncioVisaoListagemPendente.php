    ...
    <div class="row">
        <div class="column">
            <div class="ui large breadcrumb">
                ...
                <i class="right chevron icon divider"></i>
                <a class="active section">Anúncios Pendentes de Ativação</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="column">
            <div class="ui message">
                Abaixo estão seus anúncios pendentes de ativação. Em breve estarão disponíveis a serem visualizados por outras pessoas.
                Quando seu anúncio for ativado, você receberá um e-mail. Acompanhe o andamento pelo status
            </div>
        </div>
    </div>
        ...
        <div class="column">
            <div class="ui horizontal segments">
                ...
                <div class="ui segment center aligned ">
                    <i class='disabled big gray hourglass half icon'></i>Pendente de Análise: Seu anúncio ainda 
                    será analisado pela Administração do PIP Online 
                </div>
                
                <div class="ui segment center aligned ">
                    <i class='big blue hourglass half icon'></i>Em Análise: Seu anúncio está 
                    em analise pela Administração do PIP Online e, em breve, pode estar disponível para ser visualizado
                </div>
                
                <div class="ui segment center aligned ">
                    <i class='big red thumbs down icon'></i>Ativação Negada: Seu anúncio teve a ativação negada
                </div>
    ...
    <div class="row">
        <div class="column">
            <div class="ui horizontal segments">
                ...
                <div class="ui segment center aligned ">
                    <i class='disabled big gray hourglass half icon'></i>Pendente de Análise: 
                    Anúncio ainda não está em análise
                </div>
                
                <div class="ui segment center aligned ">
                    <i class='big blue hourglass half icon'></i>Em Análise: 
                    Anúncio sendo avaliado pela Administração
                </div>
                
                <div class="ui segment center aligned ">
                    <i class='big red thumbs down icon'></i>Ativação Negada: 
                    Anúncio teve a ativação negada
                </div>
        ...
        <div class="column">
            <div class="ui warning message">
                <i class="big yellow warning circle icon"></i>
                  Você não possui anúncios pendentes de ativação. Clique em voltar para retornar ao MEUPIP
            </div>
    ...
    <table class="ui red stackable table" id="tabela">
        ...
        <thead>
            <tr>
                ...
                <th>Valor</th>
                <th>Data Cadastro</th>
                <?php if($_SESSION['login'] === 'pipdiministrador'){echo "<th>Status</th>";} ?>
                <th><?php if($_SESSION['login'] != 'pipdiministrador'){echo "Status";} else echo "Operações"; ?></th>
            </tr>
        </thead>
        <tbody>
            <?php
...
<div class="ui standart modal" id="modalMudarStatus<?php echo $anuncio->getId() ?>">
    ...
    <div class="content" id="camposAlterarStatus<?php echo $anuncio->getId() ?>">
                ...
                <form class="ui form" id="formAlterarStatusAnuncio<?php echo $anuncio->getId() ?>" action="index.php" method="post">
                    ...
                    <input type="hidden" id="hdnMsgEmailEmAnalise" name="hdnMsgEmailEmAnalise" value="Seu anúncio <?php echo $anuncio->getIdAnuncio() ?> está em análise pela equipe do PIP Online e em alguns momentos pode ser ativado."/>
                    <input type="hidden" id="hdnMsgEmailAtivado" name="hdnMsgEmailAtivado" value="Parabéns! Seu anúncio <?php echo $anuncio->getIdAnuncio() ?> foi ativado. Clique no link abaixo para visualizá-lo e obrigado por anunciar no PIP Online."/>
                    ...
                    <div class="four wide required field" id="listaStatus<?php echo $anuncio->getId() ?>">
                        ...
                        <div class="ui selection dropdown">
                            ...
                            <div class="menu">
                                ...
                                <div class="item" data-value="cadastrado">Ativado</div>
                                <div class="item" data-value="ativacaonegada">Ativação Negada</div>
                            </div>
                        </div>
                    </div>          
