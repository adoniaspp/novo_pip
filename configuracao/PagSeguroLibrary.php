...
class PagSeguroLibrary
{
    ...
    {
        self::$path = dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR."assets". DIRECTORY_SEPARATOR . "pagseguro";
    ...
    {
        require_once "." . DIRECTORY_SEPARATOR . "assets" . DIRECTORY_SEPARATOR . "pagseguro" . DIRECTORY_SEPARATOR . "loader" . DIRECTORY_SEPARATOR . "PagSeguroAutoLoader.class.php";
